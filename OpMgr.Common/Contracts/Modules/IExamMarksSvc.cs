...
namespace OpMgr.Common.Contracts.Modules
{
    public interface IExamMarksSvc : ICRUDSvc<ExamMarksDTO, ExamMarksDTO>, IBatchProcess<bool>
    {
        ...
        StatusDTO<List<ExamMarksDTO>> GetStudentDetailsForMarksEntryExcel(int LocationId, int StandardSectionId, int SubjectId, DateTime fromDate, DateTime toDate, int examTypeId, int examSubTypeId, out string fileName);
